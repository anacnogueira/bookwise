        ...
        <div class="border border-stone-700 rounded">
            ...
            <form action="/livro-criar" method="post" enctype="multipart/form-data"  class="p-4 space-y-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="ano_lancamento" class="border-stone-800 border-2 rounded-md bg-stone-900 text-sm focus:outline-none px-2 py-1 w-full">
                </div>

                <button type="submit" class="border-stone-800 bg-stone-900 text-stone-400 px-4 py-1 rounded-md border-2 hover:bg-stone-700">Cadastrar</button>
            </form>
        </div>
    </div>